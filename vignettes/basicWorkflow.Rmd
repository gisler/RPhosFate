...
## Check calibration quality for SS

Snap gauges to the midpoint of the nearest channel cell if necessary and check calibration quality:
...
The `autoCalibrate()` method may provide a more comfortable alternative to this process.

## Check calibration quality for particulate phosphorus (PP)
...
Save parameters and transport calculation order to disk:
...
## Load calibrated project at a later time

Load the previously saved state of the project via the `ls_ini` argument:
